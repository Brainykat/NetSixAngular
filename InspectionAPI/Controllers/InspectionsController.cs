...
namespace InspectionAPI.Controllers
{
    ...
    public class InspectionsController : ControllerBase
    {
        ...
        public InspectionsController(InspectionContext context)
        {
            _context = context;
        }
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<Inspection>> GetInspection(Guid id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutInspection(Guid id, Inspection inspection)
        {
            if (id != inspection.Id)
            {
                return BadRequest();
